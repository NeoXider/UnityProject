...
namespace TinyGiantStudio.BetterInspector.BetterMesh
{
    ...
    public class BetterMeshSettings : ScriptableSingleton<BetterMeshSettings>
    {
        ...
        [SerializeField] private int _maxPreviewCount = 20;

        public int MaxPreviewCount
        {
            get { return _maxPreviewCount; }
            set
            {
                _maxPreviewCount = value;
                Save(true);
            }
        }
        ...
        public List<OriginalMaterial> originalMaterials = new List<OriginalMaterial>();
